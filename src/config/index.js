...
const CAN_UPDATE_USER = [USER_ROLE_OBJ.admin, USER_ROLE_OBJ.manager];

const ADMIN_CAN_UPDATE_USER_WITH_ROLE = [
  USER_ROLE_OBJ.manager,
  USER_ROLE_OBJ.moderator,
  USER_ROLE_OBJ.editor,
];

const MANAGER_CAN_UPDATE_USER_WITH_ROLE = [
  USER_ROLE_OBJ.moderator,
  USER_ROLE_OBJ.editor,
];

const ADMIN_CAN_DELETE_USER_WITH_ROLE = [
  USER_ROLE_OBJ.manager,
  USER_ROLE_OBJ.moderator,
  USER_ROLE_OBJ.editor,
];
...
const CAN_CREATE_UPDATE_ADSET = [USER_ROLE_OBJ.admin, USER_ROLE_OBJ.manager];

const CAN_CREATE_UPDATE_ADCREATIVE = [
  USER_ROLE_OBJ.admin,
  USER_ROLE_OBJ.manager,
];

const CAN_CREATE_UPDATE_AD = [
  USER_ROLE_OBJ.admin,
  USER_ROLE_OBJ.manager,
  USER_ROLE_OBJ.editor,
];
